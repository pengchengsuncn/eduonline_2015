...
<div class="act">
	...
	<a href="?c=testlist" <?php if($c=='testlist') echo 'class="on"'; ?>>试卷列表</a>
	<?php
		if($r_user['is_teacher']=="true"){
	?>
		<a href="?c=classlist" <?php if($c=='classlist' || $c=='newclass') echo 'class="on"'; ?>>班级列表</a>
		<a href="?c=learningfilelist" <?php if($c=='learningfilelist' || $c=='uploadlearningfile') echo 'class="on"'; ?>>学习资料</a>
		<a href="?c=course" <?php if($c=='course' || $c=='lesson') echo 'class="on"'; ?>>课程管理</a>
	<?php
		}else{
	?>
		<a href="?c=applyteacher" <?php if($c=='applyteacher') echo 'class="on"'; ?>>申请成为教师</a>
	<?php
		}
	?>
