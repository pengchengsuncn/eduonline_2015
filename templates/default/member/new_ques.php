...
<title><?php echo $cfg_webname; ?> - 会员中心 - 创建题目</title>
...
<div class="mainbody">
	...
	<div class="rightarea">
		...
		?>
		<form name="form" id="form" method="post" action="?a=newques">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td colspan="2" height="26"><h3 class="subtitle">《<?php echo $test['name']; ?>》 添加题目</h3></td>
				</tr>
				<tr>
					<td width="100px;" height="40" align="right">题目类型：</td>
					<td>
				...
				<tr>
					...
					<td><textarea name="title" id="title" class="kindeditor"></textarea>
						<div id="title-demo">
				...
				<tr>
					...
					<td height="130"><textarea name="option_1" id="option-1" class="class_areatext"></textarea></td>
				</tr>
				<tr>
					<td height="40" align="right">备注：</td>
					<td><textarea name="optionDesc_1" id="option-desc-1" class="class_areatext"></textarea></td>
				</tr>
				<tr>
					<td height="40" align="right">选项2：</td>
					<td height="130"><textarea name="option_2" id="option-2" class="class_areatext"></textarea></td>
				</tr>
				<tr>
					<td height="40" align="right">备注：</td>
					<td><textarea name="optionDesc_2" id="option-desc-2" class="class_areatext"></textarea></td>
				</tr>
				<tr>
					<td height="40" align="right">选项3：</td>
					<td height="130"><textarea name="option_3" id="option-3" class="class_areatext"></textarea></td>
				</tr>
				<tr>
					<td height="40" align="right">备注：</td>
					<td><textarea name="optionDesc_3" id="option-desc-3" class="class_areatext"></textarea></td>
				</tr>
				<tr>
					<td height="40" align="right">选项4：</td>
					<td height="130"><textarea name="option_4" id="option-4" class="class_areatext"></textarea></td>
				</tr>
				<tr>
					<td height="40" align="right">备注：</td>
					<td><textarea name="optionDesc_4" id="option-desc-4" class="class_areatext"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="score" id="score" class="class_input" value="" /></td>
				</tr>
				<tr>
