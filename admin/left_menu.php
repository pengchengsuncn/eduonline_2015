    ...
    <div class="overview"> 
      ...
      <div class="menubox">
        ...
        <div id="leftmenu02" style="display:none"> <a href="infoclass.php" target="main">栏目管理</a> <a href="maintype.php" target="main">二级类别管理</a>
          ...
          <div class="hr_1"> </div>
          <a href="course_type.php" target="main">课程分类管理</a> <a href="course.php" target="main">课程管理</a> <a href="course_lesson.php" target="main">课程章节管理</a> <a href="course_comment.php" target="main">课程留言管理</a></div>
      </div>
      <div class="hr_5"></div>
      <div class="menubox">
      ...
      <div class="menubox">
        ...
        <div id="leftmenu05" style="display:none;"> <a href="nav.php" target="main">导航菜单设置</a> <a href="diymenu.php" target="main">自定义菜单项</a>
          <div class="hr_1"> </div>
          <a href="mobile.php" target="main">手机网站设置</a> <a href="editfile.php" target="main">默认模板管理</a> </div>
      </div>
      <div class="hr_5"></div>
      <div class="menubox">
      ...
      <div class="menubox">
          <div class="title" onclick="DisplayMenu('leftmenu200');" title="点击切换显示或隐藏">教师信息管理</div>
          <div id="leftmenu200" class="undis">
            <a href="teacher_app.php" target="main">教师申请管理</a>
          </div>
      </div>
      <div class="menubox">
          <div class="title" onclick="DisplayMenu('leftmenu201');" title="点击切换显示或隐藏">试卷管理</div>
          <div id="leftmenu201" class="undis">
            <a href="test_list.php" target="main">试卷列表</a>
          </div>
      </div>
      <div class="menubox">
          <div class="title" onclick="DisplayMenu('leftmenu202');" title="点击切换显示或隐藏">学习资料管理</div>
          <div id="leftmenu202" class="undis">
            <a href="learning_file_list.php" target="main">学习资料列表</a>
          </div>
      </div>
      <!--scrollbar end--> 
    </div>
