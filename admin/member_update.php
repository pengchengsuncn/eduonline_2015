...
<form name="form" id="form" method="post" action="member_save.php" onsubmit="return cfm_upmember();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
        ...
        <tr>
			<td height="40" align="right">设为教师：</td>
			<td><input type="radio" name="is_teacher" id="is_teacher" value="true" <?php if($row['is_teacher'] == 'true') echo 'checked="checked"';?> />
				是 <input type="radio" name="is_teacher" id="is_teacher" value="false" <?php if($row['is_teacher'] == 'false') echo 'checked="checked"';?> />
				否</td>
		</tr>
		<tr>
