...
<body>
<?php
$row = $dosql->GetOne("SELECT * FROM `#@__course_type` WHERE `id`=$id");
?>
<div class="formHeader"> <span class="title">修改课程分类</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="course_type_save.php" onsubmit="return cfm_course_type();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		<tr>
			...
			<td><select name="parentid" id="parentid" onchange="GetCatpSize(this.value);">
					...
					<?php GetAllType('#@__course_type','#@__course_type','parentid'); ?>
				</select>
