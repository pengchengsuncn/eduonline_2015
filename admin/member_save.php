...
elseif($action == 'tuijian')
{
    $posttime = time();
	$dosql->ExecNoneQuery("INSERT INTO `#@__member_recommend` (uid, orderid, remark, posttime) VALUES('$id', '$orderid', '$remark', '$posttime')");
	ShowMsg('推荐成功！',$gourl);
	exit();
}
